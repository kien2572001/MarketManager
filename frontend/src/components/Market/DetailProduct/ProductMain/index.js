            ...
            <div className="product-main__content">
                <div className="product-main__content__left">
                    <div className="product-main__content__left__image">
                        <img src="https://chonoicairang.net/wp-content/uploads/2020/04/cam-xoan-1.jpg" alt="" />
                    </div>
                </div>
                <div className="product-main__content__right">
                    ...
                    <div className="product-main__content__name_product">
                        <h1>Cam Xoàn -"Vua" Các Loại Cam </h1>
                    </div>
                    <div className="product-main__content__dash">
                    </div>
                    ...
                    <div className="product-main__content__order_product">
                        ...
                        <Button variant="contained" sx={{ bgcolor: "#7DB249 !important", borderRadius: "1.35rem !important" }}>Thêm hàng vào giỏ</Button>
                    </div>
                    ...
                    <div className="product-main__content__right_tel">
                        <img src="https://chonoicairang.net/wp-content/uploads/2020/05/banner-si-ngang.jpg" alt="" />
                    </div>
                </div>
            </div>
        </div>
