...
export default function WhyTable() {
    ...
    return (
        <div class="card text-white  mb-3" style={{ maxWidth: '100%' }}>
            <div class="card-header" style={{ backgroundColor: '#67A448', display: 'flex', justifyContent: 'center', fontSize: '1.3rem', fontWeight: '600' }}>
                Vì sao chọn Nụ cười cá chép
            </div>
            <div class="card-body text-black" style={{ backgroundColor: '#F7F7F7' }}>
                <div>
                    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                        ...
                        <AccordionDetails>
                            <Typography>
                                Năm 2019, Nụ cười Mê Kông được trao chứng nhận “Trip Advisor 2019 Certificate of Excellence”.
                            </Typography>
                        </AccordionDetails>
                    </Accordion>
                    ...
                    <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                        ...
                        <AccordionDetails>
                            <Typography>
                                Bất kể ngày thường hay mùa lễ Tết, Nụ cười Mê Kông luôn có mức giá tốt nhất với chất lượng dịch vụ không đổi.
                            </Typography>
                        </AccordionDetails>
                    </Accordion>
                    ...
                    <Accordion expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
                        ...
                        <AccordionDetails>
                            <Typography>
                                Nụ cười Mê Kông sở hữu đội ngũ lãnh đạo, nhân viên và hướng dẫn viên giỏi, thân thiện và tận tâm với công việc.
                            </Typography>
                        </AccordionDetails>
                    </Accordion>
                </div>
