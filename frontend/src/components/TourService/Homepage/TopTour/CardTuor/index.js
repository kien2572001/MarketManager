            ...
            <CardActionArea>
                ...
                <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" className='price'>
                        <del style={{ color: '#FFA7A4', fontSize: '1.2em', marginRight: '1.3em' }}>1.050.000₫</del>
                        <ins style={{ color: '#FF5E57', fontSize: '1.2em', textDecoration: 'none', fontWeight: '700' }}>850.000₫</ins>
                    </Typography>
